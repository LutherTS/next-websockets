const data = Object.freeze({
    ...
    reads: Object.freeze({
      defs: Object.freeze({
        ...
        findExistingUsernameByDisplayUsername:
          "$COMMENT#FORCOMPOSEDVARIABLES#FINDSAN $COMMENT#FORCOMPOSEDVARIABLES#EXISTING $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSER $COMMENT#FORCOMPOSEDVARIABLES#VIAITSUNIQUE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#DISPLAYUSERNAME $COMMENT#FORCOMPOSEDVARIABLES#IFSUCHA $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSER $COMMENT#FORCOMPOSEDVARIABLES#EXISTSPERIOD" /* $COMMENT#JSDOC#READS#DEFS#FINDEXISTINGUSERNAMEBYDISPLAYUSERNAME */,
        findUserByUsername:
          "$COMMENT#FORCOMPOSEDVARIABLES#FINDSTHE $COMMENT#FORCOMPOSEDVARIABLES#EXISTING $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USER $COMMENT#FORCOMPOSEDVARIABLES#VIAITSUNIQUE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAMECOMMA $COMMENT#FORCOMPOSEDVARIABLES#ITSEXISTENCEGUARANTEED $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAMES $COMMENT#FORCOMPOSEDVARIABLES#OF $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERS $COMMENT#FORCOMPOSEDVARIABLES#AND $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#DISPLAYUSERNAMES $COMMENT#FORCOMPOSEDVARIABLES#OF $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSERS $COMMENT#FORCOMPOSEDVARIABLES#ARESAMESIMULTANEOUSLY" /* $COMMENT#JSDOC#READS#DEFS#FINDUSERBYUSERNAME */,
      }),
      params: Object.freeze({
        displayUsernameB:
  ...
  forComposedVariables: Object.freeze({
    // general
    of: "of" /* $COMMENT#FORCOMPOSEDVARIABLES#OF */,
    and: "and" /* $COMMENT#FORCOMPOSEDVARIABLES#AND */,
...
const composedVariablesExclusives = [
  "FORCOMPOSEDVARIABLES#OF",
  "FORCOMPOSEDVARIABLES#AND",
