const data = Object.freeze({
  jsDoc: Object.freeze({
    ...
    pages: Object.freeze({
      WebSockets: Object.freeze({
        ...
        returns: Object.freeze({
          getExistingUserAction:
            "$COMMENT#FORCOMPOSEDVARIABLES#EITHERTHE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAME $COMMENT#FORCOMPOSEDVARIABLES#OFTHE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSER $COMMENT#FORCOMPOSEDVARIABLES#INOBJECTORNULL" /* $COMMENT#JSDOC#PAGES#WEBSOCKETS#RETURNS#GETEXISTINGUSERACTION */,
        }),
      }),
    }),
    ...
    reads: Object.freeze({
      defs: Object.freeze({
        ...
        findExistingUsernameByDisplayUsername:
          "$COMMENT#FORCOMPOSEDVARIABLES#FINDSAN $COMMENT#FORCOMPOSEDVARIABLES#EXISTING $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSER $COMMENT#FORCOMPOSEDVARIABLES#VIAITSUNIQUE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#DISPLAYUSERNAMECOMMA $COMMENT#FORCOMPOSEDVARIABLES#IFSUCHA $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSER $COMMENT#FORCOMPOSEDVARIABLES#EXISTSPERIOD" /* $COMMENT#JSDOC#READS#DEFS#FINDEXISTINGUSERNAMEBYDISPLAYUSERNAME */,
        findUserByUsername:
          "$COMMENT#FORCOMPOSEDVARIABLES#FINDSTHE $COMMENT#FORCOMPOSEDVARIABLES#EXISTING $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USER $COMMENT#FORCOMPOSEDVARIABLES#VIAITSUNIQUE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAMECOMMA $COMMENT#FORCOMPOSEDVARIABLES#ITSEXISTENCEGUARANTEED $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAMES $COMMENT#FORCOMPOSEDVARIABLES#WORDS#OF $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERS $COMMENT#FORCOMPOSEDVARIABLES#WORDS#AND $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#DISPLAYUSERNAMES $COMMENT#FORCOMPOSEDVARIABLES#WORDS#OF $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSERS $COMMENT#FORCOMPOSEDVARIABLES#ARESAMESIMULTANEOUSLY" /* $COMMENT#JSDOC#READS#DEFS#FINDUSERBYUSERNAME */,
      }),
      params: Object.freeze({
        displayUsernameB:
      ...
      returns: Object.freeze({
        findUserByUsername:
          "$COMMENT#FORCOMPOSEDVARIABLES#EITHERTHE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#ID $COMMENT#FORCOMPOSEDVARIABLES#OFTHE $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USER $COMMENT#FORCOMPOSEDVARIABLES#INOBJECTORNULL" /* $COMMENT#JSDOC#READS#RETURNS#FINDUSERBYUSERNAME */,
      }),
    }),
  ...
  remarks: Object.freeze({
    useClient:
      "$COMMENT#FORCOMPOSEDVARIABLES#REQUIREDAMONGREASONS $COMMENT#FORCOMPOSEDVARIABLES#WORDS#CLIENT $COMMENT#FORCOMPOSEDVARIABLES#PARENSASITDOESFOR $COMMENT#FORCOMPOSEDVARIABLES#WSCLIENTPAGEPARENS $COMMENT#FORCOMPOSEDVARIABLES#NEEDSASREFERENCE" /* $COMMENT#REMARKS#USECLIENT */,
    useServer:
      "$COMMENT#FORCOMPOSEDVARIABLES#REQUIREDAMONGREASONS $COMMENT#FORCOMPOSEDVARIABLES#WORDS#SERVER $COMMENT#FORCOMPOSEDVARIABLES#PARENSASITDOESFOR $COMMENT#FORCOMPOSEDVARIABLES#WSSERVERPAGEPARENS $COMMENT#FORCOMPOSEDVARIABLES#NEEDSASREFERENCE" /* $COMMENT#REMARKS#USESERVER */,
    inlineServerActions:
  ...
  forComposedVariables: Object.freeze({
    ...
    prisma: Object.freeze({
      ...
      users: "`User`s" /* $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERS */,
      betterAuthUser:
        "`BetterAuthUser`" /* $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSER */,
      betterAuthUsers:
        "`BetterAuthUser`s" /* $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#BETTERAUTHUSERS */,
      username:
        "`username`" /* $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAME */,
      usernames:
        "`username`s" /* $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#USERNAMES */,
      usernameComma:
      ...
      displayUsernames:
        "`displayUsername`s" /* $COMMENT#FORCOMPOSEDVARIABLES#PRISMA#DISPLAYUSERNAMES */,
...
const composedVariablesExclusives = [
  ...
  "FORCOMPOSEDVARIABLES#PRISMA#USERNAMES",
  ...
  "FORCOMPOSEDVARIABLES#PRISMA#DISPLAYUSERNAMES",
